function y(h, g, b) {
    ...
    this.c = function(a, f) {
        for (var b = [], d = a, e = 0; d < a + f; d++, e++)
            b[e] = String.fromCharCode(this.a(d));
        return b.join("");
    };
    this.e = function(a, b, d) {
        ...
        switch (d.toLowerCase()) {
            ...
            case "utf-8":
                ...
                c = [];
                for (d = 0; l < e && ((b = a[l++]), 0 != b); d++)
                    128 > b ?
                    (c[d] = String.fromCharCode(b)) :
                    194 <= b && 224 > b ?
                    ((m = a[l++]),
                        (c[d] = String.fromCharCode(((b & 31) << 6) + (m & 63)))) :
                    224 <= b && 240 > b ?
                    ((m = a[l++]),
                        (k = a[l++]),
                        (c[d] = String.fromCharCode(
                            ((b & 255) << 12) + ((m & 63) << 6) + (k & 63)
                        ))) :
                    240 <= b &&
                    245 > b &&
                    ((m = a[l++]),
    ...
    function c(a, b, e, c, f, g) {
        ...
        k
            ...
            ("undefined" === typeof g && (g = !0),
                ...
                ("undefined" != typeof k.onload ?
                    ((k.onload = function() {
                            "200" == k.status || "206" == k.status ?
                                ((k.fileSize = f || k.getResponseHeader("Content-Length")),
                                    b(k)) :
                                e && e({ error: "xhr", xhr: k });
                            k = null;
                        }),
                    ...
                    (k.onreadystatechange = function() {
                        4 == k.readyState &&
                            ("200" == k.status || "206" == k.status ?
                                ((k.fileSize =
                                        f || k.getResponseHeader("Content-Length")),
                                    b(k)) :
                                e && e({ error: "xhr", xhr: k }),
                                (k = null));
                    })),
                ...
                c && k.setRequestHeader("Range", "bytes=" + c[0] + "-" + c[1]),
                k.setRequestHeader("If-Modified-Since", "Sat, 1 Jan 1970 00:00:00 GMT"),
                k.send(null)) :
            e && e({ error: "Unable to create XHR object" });
    }
    ...
    function f(a, d) {
        ...
        function h(f, g) {
            ...
            c(
                a,
                function(a) {
                    parseInt(a.getResponseHeader("Content-Length"), 10) == d &&
                        ((f[0] = 0), (f[1] = blockTotal - 1), (m[0] = 0), (m[1] = d - 1));
        ...
        blockTotal = ~~((d - 1) / e) + 1;
        for (var q in r)
            r.hasOwnProperty(q) && "function" === typeof r[q] && (this[q] = r[q]);
        this.a = function(a) {
            var b;
            h(g([a, a]));
            b = n[~~(a / e)];
            if ("string" == typeof b.data)
                return b.data.charCodeAt(a - b.offset) & 255;
            if ("unknown" == typeof b.data)
                return IEBinary_getByteAt(b.data, a - b.offset);
        };
        this.f = function(a, b) {
            h(g(a), b);
        };
    ...
    g.B = function(d, a, f) {
        ...
        (f.dataReader || C)(
            ...
            function(g) {
                g.f(c, function() {
                    var c =
                        "ftypM4A" == g.c(4, 7) ? ID4 : "ID3" == g.c(0, 3) ? ID3v2 : ID3v1;
                    c.m(g, function() {
                        var e = f.tags,
                            h = c.n(g, e),
                            e = b[d] || {},
...
(function(h) {
    ...
    g.n = function(c) {
        var d = c.h() - 128;
        if ("TAG" == c.c(d, 3)) {
            var a = c.c(d + 3, 30).replace(/\0/g, ""),
                f = c.c(d + 33, 30).replace(/\0/g, ""),
                g = c.c(d + 63, 30).replace(/\0/g, ""),
                l = c.c(d + 93, 4).replace(/\0/g, "");
            if (0 == c.a(d + 97 + 28))
                var e = c.c(d + 97, 28).replace(/\0/g, ""),
                    h = c.a(d + 97 + 29);
            else(e = ""), (h = 0);
            c = c.a(d + 97 + 30);
            return {
...
(function(h) {
    ...
    b.n = function(a, f) {
        ...
        if (t) n = {};
            ...
            for (
                var k = k - 10, t = a, e = f, m = {}, u = l.major, r = [], q = 0, p;
                (p = (e || d)[q]); q++
            )
                r = r.concat(c[p] || [p]);
            for (e = r; h < k;) {
                ...
                0 > e.indexOf(n) ||
                    (2 < u &&
                        ...
                        (p += w),
                        x && x.k.u && (g(p, q), (p += 4), (s -= 4)),
                        (x && x.k.C) ||
                        (n in b.b ? (r = b.b[n]) : "T" == n[0] && (r = b.b["T*"]),
                            (r = r ? r(p, s, q, x) : void 0),
                            (r = {
                                id: n,
                                size: s,
...
(function(h) {
    function g(b, a, f, h) {
        ...
        if (0 == l) h();
            ...
            var e = b.c(a + 4, 4); -
            1 < ["moov", "udta", "meta", "ilst"].indexOf(e) ?
                ("meta" == e && (a += 4),
                    b.f([a + 8, a + 8 + 8], function() {
                        g(b, a + 8, l - 8, h);
                    })) :
        ...
        for (var e = f; e < f + g;) {
            ...
            if (c.j[m]) {
                var u = a.o(e + 16 + 1),
                    ...
                    u = c.types[u];
                if ("trkn" == m)
                    (d[k[0]] = a.a(e + 16 + 11)), (d.count = a.a(e + 16 + 13));
                else {
                    var m = e + 16 + 4 + 4,
                        r = t - 16 - 4 - 4,
                        n;
